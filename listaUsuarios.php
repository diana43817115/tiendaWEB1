...
<button type="button" class="btn btn-danger" Lista de Productos style="BORDER: rgb(128,128,128) 1px solid; FONT-SIZE: 12pt; FONT-FAMILY: Verdana; 
  ...
  <a href="index.php" target="_blank">CLICK AQUI PARA IR A LA PAGINA PRINCIPAL</a>
  </button>  
  </div>
  <BR>
  <BR>
                          ...
                          <div class="col mb-4">
                               ...
                               <div class="card">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <h5 class="card-title"><?php echo($usuario["marca"]) ?></h5>
                                       <h5 class="card-title"><?php echo($usuario["precio"]) ?></h5>                              
